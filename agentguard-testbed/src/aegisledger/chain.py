...
class JsonRpcChainBackend:
    def __init__(
        ...
        *,
        ...
        self._validate_url(rpc_url, allow_insecure_http=allow_insecure_http)
    ...
    @staticmethod
    def _validate_url(raw_url: str, *, allow_insecure_http: bool = False) -> None:
        ...
        if parsed.scheme != "https" and not (
            parsed.scheme == "http" and (local or allow_insecure_http)
        ):
