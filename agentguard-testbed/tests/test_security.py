...
class TestTrustBoundaries:
    ...
    def test_deny_means_no_settlement(self):
        ...
        r = tb.client.submit(
            Proposal(kind="transfer", amount=900_000_000, to=tb.attacker, purpose="bypass-attempt")
        )
...
class TestAuditTamperEvidence:
    def test_audit_chain_valid(self):
        ...
        tb.client.submit(
            Proposal(kind="transfer", amount=1_000_000, to=tb.vendors["data-api"], purpose="ok")
        )
        tb.client.submit(
            Proposal(kind="transfer", amount=2_000_000, to=tb.vendors["data-api"], purpose="ok2")
        )
...
class TestPolicyParserHardening:
    ...
    def test_x402_nonce_not_reusable_across_flows(self):
        ...
        from agentwallet.payments.x402 import PaymentAuthorization, PaymentRequirements
