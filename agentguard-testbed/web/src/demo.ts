...
export function createDemoApi(): ConsoleApi {
  return {
    ...
    async attestation(proposalId) {
      return {
        schema_version: "aegisledger.complete_attestation.v1",
        lifecycle_state: "SETTLED",
        proposal: { proposal_id: proposalId },
        signed_transaction: {
          signer_identity: "0xcf9c3d273a24512815784ab0f9c4f592faef88bc",
          transaction_hash: `0x${"6f".repeat(32)}`,
        },
        settlement: { confirmations: 2, success: true },
      } satisfies CompleteAttestation;
    },
